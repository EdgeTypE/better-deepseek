...
### v0.1.5 (2026-05-06)
- **New Feature**: Advanced system prompt injection control. Choose between "Always", "First Message", or "Every X" messages with customizable intervals (Fixes #9).
...
- **New Feature**: What's New popup in the extension.S
