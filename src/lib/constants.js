...
export const DEFAULT_SYSTEM_PROMPT = [
    ...
    "6. PowerPoint Generator: <BDS:pptx>your javascript code using PptxGenJS API</BDS:pptx>",
    "7. Excel Generator: <BDS:excel>your javascript code using SheetJS (XLSX) API</BDS:excel>",
    "8. Word Document Generator: <BDS:docx>your javascript code using the docx library</BDS:docx>",
    "9. Web Fetch: <BDS:AUTO:REQUEST_WEB_FETCH>url</BDS:AUTO:REQUEST_WEB_FETCH>",
    "",
    ...
    "3. ALWAYS end with: `pptx.writeFile({ fileName: 'Presentation.pptx' });` to trigger the download.",
    "",
    "WHEN TO USE:",
    ...
    "",
    "DO NOT USE for:",
    "✗ Simple documents (use LaTeX or create_file instead).",
    ...
    "6. ALWAYS end with: `XLSX.writeFile(wb, \"Data.xlsx\");` to trigger the download.",
    "",
    "WHEN TO USE:",
    ...
    "✓ Prefer over plain markdown or LaTeX for users who need to edit the document in Word.",
    "",
    "DO NOT USE for:",
    "✗ Simple text snippets (use markdown).",
    "✗ When PDF is strictly required (use LaTeX).",
    "",
    "",
    "",
